...
const BookmarkListEditModal: React.FC<EditModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-base-100 rounded-lg p-8 w-1/2 flex flex-col z-50">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-col justify-center">
                <div className="flex gap-x-5 ">
                  ...
                  {/* 이미지 컨트롤러 */}
                  <div className="flex flex-col gap-y-2 justify-start py-2 ">
                    <label
                      className={
                        (isDark ? darkButton : lightButton) + " btn btn-outline"
                      }
                    >
                      이미지 업로드
                      <input
            ...
            <div className="mb-4 w-full">
              ...
              <div className="flex w-full">
                ...
                <button
                  ...
                  className={
                    (isDark ? darkButton : lightButton) + " btn rounded-l-none"
                  }
                  disabled={tagsLengthWarning}
                >
                  +
        ...
        <div className="w-full flex flex-row justify-end gap-4">
          ...
          <button
            className={(isDark ? darkButton : lightButton) + " btn w-24"}
            onClick={() => endEdit()}
          >
            수정
          </button>
