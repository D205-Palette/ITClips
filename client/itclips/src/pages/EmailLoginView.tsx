...
import FindPasswordModal from "../components/login/PasswordResetModal";
  ...
  return (
    <div className="bg-base-100 p-8 rounded-lg shadow-lg flex flex-col justify-content items-center container mx-auto border w-2/4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 mx-10">
        <button className="btn btn-ghost">비밀번호 찾기</button>
        <button className="btn btn-ghost" onClick={handleSignUpClick}>
          회원가입
        </button>
      </div>
      <button className="absolute top-2 right-2 btn btn-ghost">×</button>
    </div>
  );
};
