    ...
    <div className="flex flex-col items-center w-full min-h-[800px]">
      ...
      <div className="w-full h-[1024px] flex items-center justify-between px-[109px]">
        ...
        <div className="w-[750px] h-[746px] rounded-tl-[48px] rounded-bl-[48px] overflow-hidden">
          <img className="w-full h-full object-cover" src={Intro1} alt="Intro" />
        </div>
      </div>

      {/* 두 번째 섹션 */}
      <div className="w-full h-[1005px] bg-base-100 dark:bg-base-300 flex items-center justify-between px-[109px]">
        {/* 왼쪽 이미지 */}
        <div className="w-[750px] h-[746px] rounded-tr-[48px] rounded-br-[48px] overflow-hidden">
          <img className="w-full h-full object-cover" src={Intro2} alt="Intro" />
        </div>
      ...
      {/* 네 번째 섹션 */}
      <div className="w-full h-[1024px] bg-base-100 dark:bg-base-300 flex items-center justify-between px-[109px]">
        {/* 왼쪽 텍스트 */}
        <div className="flex flex-col justify-center gap-[30px]">
          <div className="text-left text-base-content dark:text-base-content text-[45px] font-bold">
            관심 북마크, 로드맵 큐레이션
        ...
        <div className="w-[593px] h-[593px] rounded-tl-[48px] rounded-bl-[48px] overflow-hidden">
          <img className="w-full h-full object-cover" src={Intro3} alt="Intro" />
        </div>
      </div>

      {/* 다섯 번째 섹션 */}
      <div className="w-full min-h-[800px] bg-gradient-to-b from-base-100 via-blue-300 to-blue-500 dark:from-base-200 dark:via-blue-800 dark:to-blue-900 flex flex-col items-center justify-end px-16 pt-24 pb-24">
        <div className="text-center text-white text-[55px] font-bold">지금 시작해 볼까요?</div>
